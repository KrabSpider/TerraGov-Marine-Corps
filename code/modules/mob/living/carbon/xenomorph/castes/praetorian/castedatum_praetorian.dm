/datum/xeno_caste/praetorian
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = 5, "bio" = 28, "rad" = 28, "fire" = 35, "acid" = 28)
...
/datum/xeno_caste/praetorian/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 35, "bullet" = 40, "laser" = 40, "energy" = 40, "bomb" = 10, "bio" = 33, "rad" = 33, "fire" = 40, "acid" = 33)
...
/datum/xeno_caste/praetorian/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = 10, "bio" = 35, "rad" = 35, "fire" = 45, "acid" = 35)
...
/datum/xeno_caste/praetorian/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 50, "laser" = 50, "energy" = 50, "bomb" = 15, "bio" = 38, "rad" = 38, "fire" = 50, "acid" = 38)
